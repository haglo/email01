...
public class ImapExampleFromOracle {
	...
	public static void dumpPart(Part p) throws Exception {
		...
		/**
		 * Dump input stream .. InputStream is = p.getInputStream(); // If "is" is not
		 * already buffered, wrap a BufferedInputStream // around it. if (!(is
		 * instanceof BufferedInputStream)) is = new BufferedInputStream(is); int c;
